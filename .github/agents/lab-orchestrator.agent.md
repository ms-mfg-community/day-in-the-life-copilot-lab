...
**User**: Add a search feature to the Students page that filters by name.

**You (orchestrator)**:

> I'll coordinate this feature across three phases.
>
> **Phase 1 — Implementation**: @dotnet-dev will add a search parameter to StudentsController.Index() and update the view.
>
> **Phase 2 — Testing**: @dotnet-qa will write unit tests for the new search logic and integration tests for the endpoint.
>
> **Phase 3 — Review**: @code-reviewer will verify the implementation follows ContosoUniversity patterns.
>
> Starting Phase 1...

Then delegate to each agent sequentially.
